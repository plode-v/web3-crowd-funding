		...
		<div className='bg-[#1c1c24] flex justify-center items-center flex-col rounded-[10px] sm:p-10 p-4'>
			...
			<form onSubmit={handleSubmit} className='w-full mt-[65px] flex flex-col gap-[30px]'>
				<div className='flex flex-wrap gap-[40px]'>
					...
					<div className='flex w-full justify-center items-center p-4 bg-[#8c6dfd] h-[120px] rounded-[10px]'>
						<img src={money} alt='money' className='w-[30px] h-[30px] object-contain' />
						<h4 className='font-epilogue pt-[10px] font-bold ml-[20px] text-[25px]' >You will get 100% of the raised amount </h4>
					</div>
					<FormField 
						labelName = "Goal *"
